...
public:
	...
	__forceinline scan_point(const Vector& point, const int& hitbox, const bool& center) //-V818 //-V730
	{
		this->point = point;
		this->hitbox = hitbox;
		this->center = center;
...
public:
	...
	virtual bool c_aimbot::get_points(C_BasePlayer* player, int ihitbox, std::vector<scan_point>& points, matrix3x4_t mx[]);
	...
	bool knife(bool* send_packet, C_BasePlayer* m_entities, CUserCmd* cmd);
