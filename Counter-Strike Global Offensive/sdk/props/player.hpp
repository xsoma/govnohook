...
public:
	...
	CCSGOPlayerAnimStateReadble* GetAnimState();
	...
	C_AnimationLayer* get_animlayers();
	...
	bool SetupBonesEx(int matrix = 0xFFF00, matrix3x4a_t* pBoneToWorld = nullptr);
	...
	void InvalidatePhysicsRecursive(InvalidatePhysicsBits_t bits);
