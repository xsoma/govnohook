...
#include <qangle/qangle.hpp>
#include <matrix/matrix.hpp>
#include <vector/CUtlVector.hpp>
...
using RecvProxyFn = void (*)(CRecvProxyData&, void*, void*);
#pragma endregion
...
class CCSGOPlayerAnimStateReadble
{
public:
...
struct matrix3x4_t
{
	...
	inline void AngleMatrixs(const Vector& angles, const Vector& position)
	{
		AngleMatrix(angles);
...
struct IBaseFileSystem
{
	...
	int Read(void* pOutput, int size, void* file)
	{
		...
		return callvfunc<Fn>(this, 0)(this, pOutput, size, file);
	}
	...
	void* Open(const char* pFileName, const char* pOptions, const char* pathID = nullptr)
	{
		...
		return callvfunc<Fn>(this, 2)(this, pFileName, pOptions, pathID);
	}

	void Close(void* file)
	{
		using Fn = void(__thiscall*)(void*, void*);
		return callvfunc<Fn>(this, 3)(this, file);
	}

	unsigned int Size(void* file)
	{
		using Fn = unsigned int(__thiscall*)(void*, void*);
		return callvfunc<Fn>(this, 7)(this, file);
	}
};
...
public:
	...
	bool IsForcedMaterialOverriden() {
		if (!materialOverride)
			return overrideType == OverrideType::DepthWrite || overrideType == OverrideType::SSaoDepthWrite;
		return std::string_view{ materialOverride->GetName() }._Starts_with(sxor("dev/glow"));
	}

	void ForcedMaterialOverride(IMaterial* mat, OverrideType type = OverrideType::Normal, int index = -1) {
		return Memory::VCall< void(__thiscall*)(void*, IMaterial*, OverrideType, int) >(this, FORCEDMATERIALOVERRIDE)(this, mat, type, index);
	}
};
