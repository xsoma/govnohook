...
//
//	__forceinline void add(const std::string& text, Color color = Color::White(), float time = 8.f, bool console = true, bool visual = true) {
...
//
//			notify->m_time -= csgo.m_globals()->frametime;
//
